    ...
    <article class="project_wrap container">
      <ul class="project_list">
        <li class="project_sort">
          <span>Frontend</span>
          <div class="projects">
            <NuxtLink to="/project/hiveplatform" class="project_link">
              하이브 플랫폼 웹사이트
            </NuxtLink>
          </div>
        </li>
        <li class="project_sort">
          ...
          <div class="projects">
            <NuxtLink to="/project/thestarlight" class="project_link">
              더 스타라이트 브랜드사이트
            </NuxtLink>
            <NuxtLink to="/project/gc" class="project_link"> GC 녹십자 채용 사이트 </NuxtLink>
          </div>
        </li>
        <li class="project_sort">
          <span>웹접근성</span>
          <div class="projects">
            <NuxtLink to="/project/cau" class="project_link"> 중앙대 원격미래 교육원 </NuxtLink>
          </div>
        </li>
        <li class="project_sort">
          <span>ETC.</span>
          <div class="projects">
            <NuxtLink to="/project/event" class="project_link"> 이벤트 페이지 </NuxtLink>
            <NuxtLink to="/project/admin" class="project_link"> 어드민 사이트 </NuxtLink>
            <NuxtLink to="/project/etc" class="project_link"> More... </NuxtLink>
          </div>
        </li>
      </ul>
    </article>
